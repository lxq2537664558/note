...
var utilFunc = {
	...
	GET: function GET(api, data, callback, failCallback, clearLogin) {
		...
		storage.getItem('userInfo', function (e) {
			if (e.result == 'success') {
				var userInfo = e.data ? JSON.parse(e.data) : {};
	...
	getRequest: function getRequest(url, header, callback, failCallback, clearLogin) {
		stream.fetch({
			method: 'GET',
			type: 'json',
			headers: header,
...
var _c = _Global2.default;
// const timer = __weex_require_module__('timer')
...
exports.default = {
	...
	mounted: function mounted() {
		...
		dom.getComponentRect(testEl, function (info) {
			if (info.size.width > 650) {
				//公告溢出时滚动
				_this2.bulletinA(testEl);
			}
		});
	},
	created: function created() {}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: {
      width: this.bulletinText.length * 22 + 22 + 'px'
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('head-nav', {
    ...
    return _c('div', {
      ...
      }, [_vm._v(_vm._s(_vm.test) + _vm._s(action.title))])])
    }))
  })), _c('div', {
    staticStyle: {
      height: "415px"
						...
						this.confirm = {
							...
							action: function action() {
								...
								_util2.default.GET('member/weekLulu', {}, function (e) {
									...
									_this.$parent.tipList.text = '您本周的俸禄已领完 (╯︵╰)';
									_this.$parent.tipList.submitShow = false;
								}, function () {
						...
						this.confirm = {
							...
							action: function action() {
								...
								_util2.default.GET('member/monthLulu', {}, function (e) {
									...
									_this.$parent.tipList.show = true;
									_this.$parent.tipList.type = 'default';
									_this.$parent.tipList.text = '您本月的俸禄已领完 (╯︵╰)';
									_this.$parent.tipList.submitShow = false;
								}, function () {
									self.$parent.clearLogin();
								});
			...
			storage.getItem('lastSignIn', function (e) {
				if (e.result == 'success' && e.data == new Date().toLocaleDateString()) {
					...
					_util2.default.GET('member/register', {}, function (rst) {
						...
						_this2.maskSignInShow = true;
						_this2.$parent.bottomMaskShow = true;
					}, function (rst) {
						modal.toast({
							message: rst.data.message,
							duration: 1
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('head-nav', {
    ...
    staticClass: ["center-list-scroller"]
  }, [_c('div', {
	...
	data: function data() {
		return {
			...
			msgRecodeList: [{
				...
				logo: _c.sUrl + '/images/round/activity_announcement.png',
				url: '1'
			}, {
				t1: '存款公告',
				t2: '显示未读消息',
				logo: _c.sUrl + '/images/round/deposit_announcement.png',
				url: '1'
			}, {
				t1: '游戏公告',
				t2: '显示未读消息',
...
exports.default = {
	...
	data: function data() {
		return {
			...
			// 设置列表
			settingList: [{
				logo: _c.sUrl + '/images/msg_gray.png',
				title: '消息提醒设置',
				url: '1'
			}, {
				logo: _c.sUrl + '/images/del_gray.png',
				title: '清除系统缓存',
				url: '1'
			}, {
				logo: _c.sUrl + '/images/problem_gray.png',
				title: '问题求助',
				url: '1'
			}, {
				logo: _c.sUrl + '/images/note_gray.png',
				title: '投诉与建议',
				url: '1'
			}, {
				logo: _c.sUrl + '/images/on_app_gray.png',
				title: '关于APP',
				url: '1'
			}],

			rightArrow: _c.sUrl + '/images/right_arrow.png',
			testUrl: _c.sUrl + '/images/route_blurry_background.png'
		};
	},
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('head-nav-text', {
  ...
  }, [_vm._v("VIP " + _vm._s(_vm.user.currentLevel))])]), _c('img', {
    staticStyle: {
      height: "45px",
      width: "45px",
      position: "absolute",
    ...
    staticClass: ["star-text"]
  }, [_vm._v("VIP " + _vm._s(_vm.user.preLevel || _vm.user.currentLevel))])]), _c('img', {
    staticStyle: {
      height: "45px",
      width: "45px",
      position: "absolute",
...
exports.default = {
	...
	methods: {
		...
		auth: function auth(page) {
			...
			if (this.userInfo.username) {} else {
				modal.alert({
					message: '请先登录',
					duration: 0.3
				}, function () {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_vm._v(_vm._s(_vm.test) + _vm._s(nav.title))])])
  }))
},staticRenderFns: []}
module.exports.render._withStripped = true
